...
const Navigation = ({ className }) => {
  return (
    <div className={className}>
      <div className="text-lg font-main font-bold text-white bg-gradient-to-r from-green to-blue h-14 px-8 py-2 flex gap-16 w-[98.7vw] lg:h-20 xl:h-14">
            ...
            <div className="py-1 pl-4 lg:py-4 xl:py-1">
                <SearchBar />
            </div>
